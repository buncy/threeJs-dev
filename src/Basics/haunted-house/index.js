...
export default () => {
  ...
  const roof = new THREE.Mesh(
    new THREE.ConeGeometry(3.8, 1, 4, 1, true),
  ...
  const bush1 = new THREE.Mesh(bushes, bushMaterial);
  bush1.scale.set(0.5, 0.5, 0.5);
  bush1.position.set(0.8, 0.2, 2.2);

  const bush2 = new THREE.Mesh(bushes, bushMaterial);
  bush2.scale.set(0.3, 0.3, 0.3);
  bush2.position.set(-0.8, 0.2, 2.2);

  const bush4 = new THREE.Mesh(bushes, bushMaterial);
  bush4.scale.set(0.4, 0.4, 0.4);
  bush4.position.set(-1, 0.2, 2.6);

  const bush5 = new THREE.Mesh(bushes, bushMaterial);
  bush5.scale.set(0.2, 0.2, 0.2);
  bush5.position.set(-1, 0.1, 3);

  const bush3 = new THREE.Mesh(bushes, bushMaterial);
  ...
  // const grave1 = new THREE.Mesh(graveGeometry, gravesMaterial);
  // grave1.position.set(-3, 0.4, 1);
  // graves.add(grave1);
  // Floor
